...
print("Nonconvex QP problem with {} variables, {} inequalities, {} equalities and {} examples".format(num_var, num_ineq, num_eq, num_examples))
seed = 2025
np.random.seed(seed)
...
with open("datasets/nonconvex/qp/2random{}_qp_dataset_var{}_ineq{}_eq{}_ex{}".format(seed, num_var, num_ineq, num_eq, num_examples), 'wb') as f:
    pickle.dump(data, f)

print("Finished generating nonconvex QP dataset")