...
num_examples = 20000
seed = 2025
print("Nonsmooth nonconvex QCQP problem with {} variables, {} inequalities, {} equalities and {} examples".format(num_var, num_ineq, num_eq, num_examples))
...
with open("datasets/nonsmooth_nonconvex/qcqp/random{}_qcqp_dataset_var{}_ineq{}_eq{}_ex{}".format(seed, num_var, num_ineq, num_eq, num_examples), 'wb') as f:
    pickle.dump(data, f)